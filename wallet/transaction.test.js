    ...
    describe("and the amount is valid", () => {
      ...
      describe('and another update for the same recipient', () => {
        ...
        beforeEach(() => {
          addeddAmount = 80
          transaction.update({
            senderWallet, recipient: nextRecipient, amount: addeddAmount
          })
        })
        it('adds to the recipient amount', () => {
          expect(transaction.outputMap[nextRecipient])
            .toEqual(nextAmount + addeddAmount)
        })

        it('subtracts the amount from the original sender output amount', () => {
          expect(transaction.outputMap[senderWallet.publicKey]).toEqual(originalSenderOutput - nextAmount - addeddAmount)
        })
      })
    })
